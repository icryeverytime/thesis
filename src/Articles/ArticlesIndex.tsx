...
/*
<h3 className="text-xl font-semibold leading-normal mb-2 text-blueGray-700 mb-2 -mt-8">asdasd</h3>


<img
                  alt="..."
                  src={profilePic}
                  className="shadow-xl h-auto align-middle mt-12 -mb-16"
                />
      ...
      <div className="relative flex flex-col min-w-0 break-words bg-white w-80% mx-32 mb-12 shadow-xl rounded-lg -mt-16">
        ...
        <div className="px-6">
          <div className="flex flex-wrap justify-center">
            ...
            <h3 className="text-2xl font-semibold leading-normal mb-2 text-blueGray-700 mb-2 -mt-8">This is a generic title on an article</h3>
            <div className="w-full px-4 flex justify-center">
            <img
                  alt="..."
                  src={profileBG}
              ...
              <div className="flex justify-center py-4 lg:pt-4 pt-8">
                ...
                <div className="mr-4 p-3 text-center">
                  ...
                  <span className="text-sm text-blueGray-400">ICryEveryTime</span>
                </div>
                <div className="mr-4 p-3 text-center">
