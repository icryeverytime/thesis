...
function Home(){
     return(
      ...
      <img
          ...
          alt="..."
        />
      <div className="relative flex flex-col min-w-0 break-words bg-white w-80% mx-32 mb-6 shadow-xl rounded-lg mt-16">
        <div className="px-6">
          ...
          <div className="text-center mt-12">
            <h3 className="text-xl font-semibold leading-normal mb-2 text-blueGray-700 mb-2 -mt-12">
