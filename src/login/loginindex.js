    ...
    return (
        ...
        <div id="css-selector">
            <div className="flex justify-center container mx-auto my-auto w-screen h-screen items-center flex-col">
                ...
                <div className="w-full md:w-3/4 bg-dodger-blue  lg:w-1/2 flex flex-col items-center rounded-md pt-12">
                    ...
                    <div className="w-3/4 mb-12">
                        <button type="submit" className="py-4 bg-purple w-full rounded text-blue-50 font-bold hover:bg-blue-700"> LOGIN</button>
                    </div>
                </div>
